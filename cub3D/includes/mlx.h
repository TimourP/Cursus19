...
**  x and y must fit into the size of the window, no
**	control is done on the values
*/
...
**  usefull in a network environment where graphical app
**	show on a remote monitor that can have a different endian
*/
